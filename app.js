...
(() => {
  ...
  function renderPainel() {
    ...
    if (main) {
      ...
      focusHtml = `
        <div class="focus-card card-enter">
  ...
  function renderGoalCard(goal, index = 0) {
    ...
    return `
      <div class="goal-card card-enter ${goal.completedAt ? "completed" : ""}" data-goal-id="${goal.id}" style="animation-delay:${Math.min(index * 0.05, 0.3)}s">
        ...
        completedGoals.length
          ...
          <div class="goals-grid mt-16">
            ${completedGoals
              .map(
                (g, i) => `
              <div class="goal-card completed card-enter" style="animation-delay:${Math.min(i * 0.05, 0.3)}s">
